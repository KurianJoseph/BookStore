...
const BookSingleCard = ({ book }) => {
  ...
  return (
    <div className=" rounded-3xl overflow-hidden w-80 h-auto bg-[#2B2B2B] text-white shadow-md font-mono">
    <div className="w-full h-72">
      ...
      <div className="w-6 h-6 flex justify-center items-center rounded-full overflow-hidden">
              <img className="w-full h-full object-cover" src="https://via.placeholder.com/24x24" />
            </div>
            <h4>{book.author}</h4>
      </div>  
